...
function CertificateCard({ cert }) {
  const tiltRef = useMouseTilt({ maxTilt: 15, scale: 1.03, speed: 400 })

  return (
    <motion.div variants={cardVariants} layout>
      <div ref={tiltRef} className="card overflow-hidden shine-effect group">
        {/* Top gradient banner */}
    ...
    <section id="certificates" className="section-padding bg-gray-50 dark:bg-gray-900/50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Verified credentials and course completions
          </motion.p>
        </div>
